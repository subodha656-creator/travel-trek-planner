  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 bg-opacity-50 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-hidden">
        <div className="bg-gradient-to-r from-travel-primary to-travel-primary-light text-white p-6 relative">
          <Button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="text-center">
            ...
            <Button
              type="button"
              onClick={triggerFileInput}
              className="mt-3 flex items-center bg-white border-[outset]/40 justify-center space-x-2 px-4 py-2 text-sm text-travel-prfrom-travel-primary border border-travel-prfrom-travel-primary rounded-lg hover:bg-blue-50 transition-colors mx-auto"
            >
          ...
          <div className="flex space-x-3 pt-4">
            <Button
              type="button"
              onClick={onClose}
              className="flex-1 px-4 py-3 border bg-travel-secondary text-white hover:bg-travel-secondary-light border-[outset]/40  rounded-xl transition-colors font-medium"
            >
              Cancel
            </Button>
            <Button
              type="submit"
              disabled={isLoading}
              className="flex-1 px-4 py-3 bg-gradient-to-r from-travel-primary to-travel-primary-light text-white rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all font-medium flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
                <>
