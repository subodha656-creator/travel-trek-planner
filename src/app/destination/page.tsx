    ...
    const fetchDestinations = async () => {
      try {
        ...
        if (
          ...
          Array.isArray(data.filteredDestinations)
        ) {
          const shuffled = [...data.filteredDestinations].sort(
            () => 0.5 - Math.random()
          );
          const randomFive = shuffled.slice(0, 5);

          setDestinations(randomFive);

          if (randomFive.length > 0) {
            setSelectedDestination(randomFive[0]);
          }
        } else {
          setDestinations([]);
        }
      ...
      <div className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
          ...
          <p className="text-xl text-white font-semibold mb-8 leading-relaxed">
            ...
            Users and Trekking Experts.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            {destinations && destinations.length > 0 ? (
              destinations.map((dest: Record<string, any>, index) => (
                <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="space-y-6">
            ...
            <Button
              ...
              className="w-full bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white font-bold py-4 px-8 rounded-4xl transition-all duration-300 transform hover:scale-105 shadow-2xl flex items-center justify-center space-x-2"
            >
